package com.les.understandingJVM.method_interface;
...
public class ReflectStudy {
	...
	public static void main(String[] args) {
		try {
			Class<?> carClass = Class.forName("com.taomk.PrivateCar");
//			ClassLoader loader = Thread.currentThread().getContextClassLoader();
//			Class<?> carClass = loader.loadClass("com.taomk.PrivateCar");
